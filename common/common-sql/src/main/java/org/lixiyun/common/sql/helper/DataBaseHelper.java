package org.lixiyun.common.sql.helper;
...
import org.lixiyun.common.sql.enums.DataBaseType;
...
public class DataBaseHelper {
    ...
    public static DataBaseType getDataBaseType() {
        ...
        try (Connection conn = dataSource.getConnection()) {
            ...
            throw new MyBatisException(MyBatisExceptionEnum.SQL_ERROR.getCode(), e.getMessage());
        }
    }
    ...
    public static List<String> getCurrentDataSourceTableNameList() {
        ...
        try (Connection conn = dataSource.getConnection()) {
            ...
            throw new MyBatisException(MyBatisExceptionEnum.SQL_ERROR.getCode(), "获取表名称失败: " + e.getMessage());
        }
        return tableNames;
    }
    ...
    public static List<Map<String, Object>> getTableColumnInfo(String tableName) {
        ...
        try (Connection conn = dataSource.getConnection()) {
            ...
            throw new MyBatisException(MyBatisExceptionEnum.SQL_ERROR.getCode(), "获取表字段信息失败: " + e.getMessage());
        }
