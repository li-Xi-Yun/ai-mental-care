...
public class QueueUtils {
    ...
    /**
     * 添加优先队列数据，存放的数据必须有实现Comparable接口
     *
     * @param queueName 队列名
     * @param data      数据
     */
     ...
     * @param queueName 队列名
     */
    public static  <T extends Comparable<?>> T getPriorityQueueObject(String queueName) {
        RPriorityBlockingQueue<T> priorityBlockingQueue = CLIENT.getPriorityBlockingQueue(queueName);
     ...
     * @param data 数据
     */
    public static  <T extends Comparable<?>> boolean removePriorityQueueObject(String queueName, T data) {
        RPriorityBlockingQueue<T> priorityBlockingQueue = CLIENT.getPriorityBlockingQueue(queueName);
     ...
     * @param queueName 队列名
     */
    public static  <T extends Comparable<?>> boolean destroyPriorityQueue(String queueName) {
        RPriorityBlockingQueue<T> priorityBlockingQueue = CLIENT.getPriorityBlockingQueue(queueName);
    ...
    /**
     * 尝试设置 有界队列 容量 用于限制数量
     *有界队列只是说这个队列所存放的数据数量是有上限的，其他的与普通队列是一样的
     *
     * @param queueName 队列名
     * @param capacity  容量
     */
