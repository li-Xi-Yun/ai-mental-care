...
public class AdminQueryDTO implements Serializable {
    ...
    @Schema(description = "管理员用户名（支持模糊匹配）", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private String username;

    @Schema(description = "管理员ID（精确匹配）", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
