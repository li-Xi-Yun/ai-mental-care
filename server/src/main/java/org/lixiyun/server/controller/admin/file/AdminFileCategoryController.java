...
public class AdminFileCategoryController {
    ...
    @PostMapping
//    @PreAuthorize("hasAuthority('admin:file:category:create')")
    ...
    @PutMapping
//    @PreAuthorize("hasAuthority('admin:file:category:update')")
...
//    @PreAuthorize("hasAuthority('admin:file:category:delete')")
...
//    @PreAuthorize("hasAuthority('file:category:list')")
    ...
    @GetMapping
//    @PreAuthorize("hasAuthority('admin:file:category:list:all')")
...
//    @PreAuthorize("hasAuthority('admin:file:category:list:detail')")
