...
public class TextController {
    ...
    @Operation(summary = "心理文本场景对话接口", description = """
    ...
    """)
    @RateLimit(type = RateLimit.RateLimitType.INTERFACE, key = "emotion-text", maxRequests = 1, windowSizeInMillis = 2000)
    public Flux<String> scenarioChat(@RequestBody @Validated ScenarioChatDTO scenarioChatDTO) throws GraphStateException {
        log.info("心理文本场景对话接口：{}", scenarioChatDTO);
        Flux<String> result = textService.scenarioChat(scenarioChatDTO);
        return result;
    }
