...
import org.lixiyun.pojo.dto.scale.AnswerItemDTO;
import org.lixiyun.pojo.dto.scale.ScaleUserAnswerDTO;
import org.lixiyun.pojo.entity.scale.*;
import org.lixiyun.pojo.vo.scale.ScaleUserAnswerVO;
import org.lixiyun.pojo.vo.scale.ScaleUserRecordVO;
import org.lixiyun.server.mapper.*;
import org.lixiyun.server.service.ScaleUserService;
...
public class ScaleUserServiceImpl implements ScaleUserService {
    ...
    public PageResult<ScaleUserRecordVO> listRecords(Integer pageNum, Integer pageSize) {
        ...
        Page<ScaleUserRecord> recordPage = scaleUserRecordMapper.selectPage(pageParam, wrapper);
    ...
    public PageResult<ScaleUserAnswerVO> listAnswerDetails(Long recordId, Integer pageNum, Integer pageSize) {
        ...
        LambdaQueryWrapper<ScaleUserAnswer> wrapper = new LambdaQueryWrapper<ScaleUserAnswer>()
        ...
        Page<ScaleUserAnswer> answerPage = scaleUserAnswerMapper.selectPage(pageParam, wrapper);
