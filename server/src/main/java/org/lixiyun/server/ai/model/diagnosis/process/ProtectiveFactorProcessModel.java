...
public class ProtectiveFactorProcessModel extends BaseModel {
    ...
    public ProtectiveFactorResult callForResult(ChatModel chatModel, String userPrompt, AiNodeConfig config, RunnableConfig runnableConfig) throws GraphRunnerException {
