...
public class SymptomNormalizeModel extends BaseModel {
    ...
    public SymptomNormalizeModelResult callForResult(ChatModel chatModel, String userPrompt, AiNodeConfig config, RunnableConfig runnableConfig) throws GraphRunnerException {
